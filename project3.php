...
<section class="project-banner">
  <div class="banner-overlay">
    <div class="banner-content">
      <h1>Specialized Neurology Treatments <br>You Can Trust</h1>
        <!-- Breadcrumb -->
  ...
  <div class="project-wrapper">
    ...
    <div class="project-image">
      <img src="images/neurosur2.jpg" alt="Surgical Heart Bypass">
    </div>
    ...
    <div class="project-content">
      ...
      <p>
     Spinal cord decompression surgery is a specialized procedure performed to
relieve pressure on the spinal cord or surrounding nerves caused by injury,
degenerative conditions, or spinal disorders. This critical surgical treatment
helps reduce pain, restore nerve function, and improve mobility in affected
patients. Our skilled spine specialists use advanced surgical techniques to
safely decompress the spine, prevent further nerve damage, and support long-term
neurological recovery.

      </p>

      <a href="project6.php" class="project-btn">
        View Details
      </a>
    </div>
...
<section class="project-section">
  <div class="project-wrapper reverse">
    ...
    <div class="project-content">
      ...
      <p>
      Rehabilitation therapy is a structured treatment program designed to restore
physical strength, mobility, and functional independence after illness, injury,
or surgery. This essential therapy supports recovery by improving movement,
reducing pain, and enhancing overall quality of life. Our dedicated
rehabilitation team provides personalized therapy plans using modern techniques
to promote healing, regain confidence, and achieve long-term functional
well-being.
    ...
    <!-- RIGHT IMAGE -->
    <div class="project-image">
      <img src="images/general3.jpg" alt="Angioplasty & Stent Placement">
    </div>
