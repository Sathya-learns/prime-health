...
<section class="service-detail-section">
  ...
  <div class="service-detail-container">
    ...
    <div class="service-detail-left">
      <img src="images/facility1.jpeg" alt="Emergency Checkup Service">
    ...
    <div class="service-detail-right">
      ...
      <h2>Gynecological Care</h2>
      <p class="service-intro">
        Comprehensive women’s health care with expert
         pregnancy and gynecological services.
      </p>

      <!-- SERVICES -->
      <div class="service-box">
        <h4><i class="icon-heartbeat"></i> Services We Offer</h4>
        <ul>
         <li>Comprehensive Women's Health Care</li>
<li>Pregnancy & Antenatal Services</li>
<li>Menstrual & Hormonal Disorder Treatment</li>
<li>Gynecological Diagnostics & Procedures</li>
      ...
      <div class="service-box highlight">
        ...
        <p>
          ...
          <br>12+ years experience in acute care
        </p>
      </div>
      ...
      <div class="service-box">
        ...
        <p>
         Handled over <strong>8,000+ gynecology cases</strong> with expert
          maternal care, advanced treatments, and continuous support to 
  ...
  <div class="service-prevention-container">
    ...
    <div class="service-prevention-left">
      ...
      <div class="prevention-card">
        ...
        <p>Schedule Pap smears, mammograms, and other gynecological tests regularly.</p>
      </div>

      <div class="prevention-card">
        <h3>Healthy Lifestyle</h3>
        <p>Balanced diet, exercise, and adequate sleep support reproductive health.</p>
      </div>

      <div class="prevention-card">
        <h3>Preventive Education</h3>
        <p>Stay informed about reproductive health, menstrual hygiene, and pregnancy care.</p>
      </div>
    ...
    <div class="service-prevention-right">
      <h2>Preventive Measures for Gynecology Care</h2>
      <ul class="prevention-points">
         <li>Attend regular gynecological checkups and screenings for early detection</li>
        <li>Maintain balanced diet and healthy lifestyle habits consistently daily</li>
        <li>Practice proper menstrual hygiene to prevent infections and discomfort</li>
        <li>Consult doctor for reproductive health and pregnancy concerns promptly</li>
        <li>Follow recommended vaccinations and preventive measures during pregnancy</li>
        <li>Track menstrual cycles and note any abnormal symptoms carefully</li>
        <li>Engage in regular physical activity to support reproductive health effectively</li>
        <li>Avoid smoking, alcohol, and unhealthy habits for better reproductive function</li>
        <li>Ensure adequate sleep and stress management to maintain overall health</li>
        <li>Educate about reproductive health and wellness for informed decisions always</li>
        <li>Seek medical advice for any abnormal symptoms immediately to prevent complications</li>
      </ul>
    </div>
