...
<section class="service-detail-section">
  ...
  <div class="service-detail-container swap-left-right">

    <!-- RIGHT IMAGE SIDE (was left before) -->
    <div class="service-detail-left">
      <img src="images/pedia.jpg" alt="Pediatric Service">
    ...
    <!-- LEFT CONTENT SIDE (was right before) -->
    <div class="service-detail-right">

      <h2>Pediatric Treatments</h2>
      <p class="service-intro">
        Our pediatric department offers complete child care from newborns to adolescents,
        ensuring healthy growth and early disease prevention.
      </p>

      <!-- TREATMENTS -->
      <div class="service-box">
        <h4><i class="icon-child"></i> Treatments We Offer</h4>
        <ul>
      ...
      <div class="service-box highlight">
        ...
        <p>
          Dr. Sophia Lee – Senior Pediatrician  
          <br>10+ years experience in child healthcare
        </p>
      </div>
      ...
      <div class="service-box">
        ...
        <p>
          Successfully cared for over <strong>5,000+ children</strong>
          ensuring healthy growth and recovery.
        </p>
      </div>
  ...
  <div class="service-prevention-container">
    ...
    <div class="service-prevention-left">
      ...
      <div class="prevention-card">
        ...
        <p>Ensure children get balanced meals with essential vitamins and minerals for proper growth.</p>
      </div>

      <div class="prevention-card">
        <h3>Regular Checkups</h3>
        <p>Schedule routine pediatric visits to monitor growth, vaccination, and overall health.</p>
      </div>

      <div class="prevention-card">
        <h3>Hygiene Practices</h3>
        <p>Teach kids proper handwashing, dental care, and hygiene habits to prevent common illnesses.</p>
      </div>
    ...
    <div class="service-prevention-right">
      <h2>Preventive Measures for Pediatric Care</h2>
      <ul class="prevention-points">
        <li>Vaccinate children according to recommended schedule regularly</li>
        <li>Monitor growth and developmental milestones consistently</li>
        <li>Encourage daily physical activity and active play at home</li>
        <li>Provide balanced diet rich in fruits, vegetables and proteins</li>
        <li>Teach proper handwashing and personal hygiene habits</li>
        <li>Ensure adequate sleep for proper growth and development</li>
        <li>Schedule vision and hearing checks periodically for children</li>
        <li>Prevent accidents by maintaining safe home environment daily</li>
        <li>Limit screen time and promote outdoor activities for health</li>
        <li>Encourage social interaction and mental stimulation activities</li>
        <li>Monitor emotional well-being and consult pediatrician when needed</li>
      </ul>
    </div>
