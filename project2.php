...
<section class="project-banner">
  ...
  <div class="project-wrapper">
    ...
    <div class="project-image">
      <img src="images/cpr2.jpg" alt="Surgical Heart Bypass">
    </div>
...
when the heart or breathing suddenly stops. This critical intervention helps
restore blood circulation and oxygen supply to vital organs during cardiac
arrest situations. Our trained emergency response team follows advanced
life-support protocols to stabilize patients, prevent organ damage, and
increase survival chances until advanced medical care is provided.

      </p>

      <a href="project5.php" class="project-btn">
        View Details
      </a>
    </div>
...
<section class="project-section">
  <div class="project-wrapper reverse">
    ...
    <div class="project-content">
      ...
      <p>
Acute medical interventions involve immediate and decisive treatment for
sudden, severe, or life-threatening medical conditions. These rapid-response
procedures are designed to stabilize patients, control critical symptoms, and
prevent further complications. Our emergency care specialists use advanced
monitoring, medications, and clinical expertise to deliver timely treatment
that supports recovery and ensures patient safety.
    ...
    <!-- RIGHT IMAGE -->
    <div class="project-image">
      <img src="images/emergency1.jpg" alt="Angioplasty & Stent Placement">
    </div>
