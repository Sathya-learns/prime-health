...
<section class="readmore-banner">
  <div class="readmore-overlay">
    <div class="readmore-content">
      <h1>Comprehensive Heart Care</h1>
             <!-- Breadcrumb -->
  ...
  <div class="service-detail-container">
    ...
    <div class="service-detail-left">
      <img src="images/cardio.jpg" alt="Cardiology Service">
    ...
    <div class="service-detail-right">
      ...
      <h2>Advanced Cardiology Treatments</h2>
      <p class="service-intro">
        Our cardiology department provides comprehensive heart care using
        advanced diagnostic tools and experienced specialists.
      </p>

      <!-- TREATMENTS -->
      <div class="service-box">
        <h4><i class="icon-heart"></i> Treatments We Offer</h4>
        <ul>
          <li>ECG & Echo Testing</li>
      ...
      <div class="service-box highlight">
        ...
        <p>
          Dr. Daniel Wilson – Senior Cardiologist  
          <br>15+ years experience in heart care
        </p>
      </div>
      ...
      <div class="service-box">
        ...
        <p>
          Successfully treated over <strong>8,000+ cardiac patients</strong>
...
<section class="cardio-prevention-section">

  <div class="cardio-prevention-container">

    <!-- LEFT CARDS -->
    <div class="cardio-prevention-left">

      <div class="prevention-card">
        <h3>Healthy Lifestyle</h3>
        <p>
          Maintain a balanced diet, regular physical activity and
          stress-free routine to protect your heart health.
        </p>
      </div>

      <div class="prevention-card">
        <h3>Regular Heart Checkups</h3>
        <p>
          Routine heart screenings help detect problems early
          and prevent serious cardiac conditions.
        </p>
      </div>

      <div class="prevention-card">
        <h3>Control Risk Factors</h3>
        <p>
    ...
    <!-- RIGHT CONTENT -->
    <div class="cardio-prevention-right">

      <h2>Preventive Measures for Cardiology Care</h2>

      <ul class="prevention-points">
        <li>Adopt a heart-healthy diet rich in fruits, vegetables and whole grains</li>
        <li>Engage in regular physical activity for at least 30 minutes daily</li>
        <li>Avoid smoking and limit alcohol consumption</li>
        <li>Monitor blood pressure, cholesterol and sugar levels regularly</li>
        <li>Manage stress through meditation, yoga or relaxation techniques</li>
        <li>Get regular cardiac checkups even if symptoms are not present</li>
        <li>Maintain ideal body weight to reduce heart strain effectively daily</li>
        <li>Ensure quality sleep for better heart function and recovery consistently</li>
        <li>Limit salt intake to control blood pressure levels naturally daily</li>
        <li>Stay hydrated to support healthy blood circulation and heart function</li>
        <li>Follow regular health monitoring for early cardiac risk detection always</li>
      </ul>
