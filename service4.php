...
<section class="readmore-banner">
  ...
  <div class="service-detail-container">
    ...
    <div class="service-detail-left">
      <img src="images/emergency1.jpg" alt="Emergency Service">
    ...
    <div class="service-detail-right">
      ...
      <h2>24/7 Emergency Checkup</h2>
      <p class="service-intro">
        Our emergency department is available round the clock to handle
        critical and life-threatening conditions immediately.
      </p>

      <div class="service-box">
        <h4><i class="icon-alert"></i> Emergency Services</h4>
        <ul>
          <li>Trauma & Accident Care</li>
          <li>Cardiac Emergency</li>
          <li>Rapid Diagnostics</li>
          <li>Immediate Medical Response</li>
        </ul>
      </div>

      <div class="service-box highlight">
        <h4><i class="icon-doctor"></i> Emergency Team</h4>
        <p>
          Expert emergency doctors & nurses  
          <br>Available 24/7 for critical care
        </p>
      </div>

      <div class="service-box">
        <h4><i class="icon-star"></i> Trusted Care</h4>
        <p>
          Handled over <strong>12,000+ emergency cases</strong> with fast
          response and care.
        </p>
      </div>
  ...
  <div class="service-prevention-container">
    ...
    <div class="service-prevention-left">
      ...
      <div class="prevention-card">
        ...
        <p>Be prepared to handle emergencies immediately with proper knowledge and resources.</p>
      </div>

      <div class="prevention-card">
        <h3>First Aid Knowledge</h3>
        <p>Learn essential first aid skills for home and workplace safety.</p>
      </div>

      <div class="prevention-card">
        <h3>Regular Safety Checks</h3>
        <p>Maintain safe environment at home and work to prevent accidents.</p>
      </div>
    ...
    <div class="service-prevention-right">
      <h2>Preventive Measures for Emergency Care</h2>
      <ul class="prevention-points">
        <li>Keep emergency contacts and hospital numbers handy at all times</li>
        <li>Learn CPR and basic first aid for immediate response to incidents</li>
        <li>Maintain a fully stocked first aid kit accessible at home and office</li>
        <li>Check home and workplace environment regularly for potential hazards</li>
        <li>Develop an emergency evacuation plan for all family members</li>
        <li>Ensure children and elderly know basic safety instructions clearly</li>
        <li>Stay informed about local emergency services and response protocols</li>
        <li>Practice fire drills and emergency scenarios periodically every month</li>
        <li>Avoid risky activities and use protective equipment whenever necessary</li>
        <li>Monitor health conditions that could cause sudden emergencies consistently</li>
        <li>Consult professionals to improve emergency preparedness and safety planning</li>
      </ul>
    </div>
