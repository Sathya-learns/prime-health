...
<section class="readmore-banner">
  <div class="readmore-overlay">
    <div class="readmore-content">
      <h1>General Consultation Services</h1>
             <!-- Breadcrumb -->
  ...
  <div class="service-detail-container">
    ...
    <div class="service-detail-right">
      ...
      <h2>Complete General Health Consultation</h2>
      <p class="service-intro">
        Our general consultation service focuses on early diagnosis,
        routine checkups and complete family healthcare.
      </p>

      <div class="service-box">
        <h4><i class="icon-checkup"></i> Services Included</h4>
        <ul>
          <li>Routine Health Checkups</li>
          <li>Fever & Infection Treatment</li>
          <li>Diabetes & BP Monitoring</li>
          <li>Preventive Healthcare</li>
        </ul>
      </div>

      <div class="service-box highlight">
        <h4><i class="icon-doctor"></i> Consulting Doctor</h4>
        <p>
          Dr. Emily Johnson – General Physician  
          <br>10+ years experience in family medicine
        </p>
      </div>

      <div class="service-box">
        <h4><i class="icon-star"></i> Patient Trust</h4>
        <p>
          Over <strong>20,000+ happy patients</strong> served with care
          and compassion.
        </p>
      </div>
  ...
  <div class="service-prevention-container">
    ...
    <div class="service-prevention-left">
      ...
      <div class="prevention-card">
        ...
        <p>Consult your physician regularly to prevent minor issues from becoming serious.</p>
      </div>

      <div class="prevention-card">
        <h3>Health Awareness</h3>
        <p>Stay informed about your health and lifestyle to make proactive choices.</p>
      </div>

      <div class="prevention-card">
        <h3>Personalized Care</h3>
        <p>Follow doctor’s guidance tailored to your health needs and history.</p>
      </div>
    ...
    <div class="service-prevention-right">
      <h2>Preventive Measures for General Consultation</h2>
      <ul class="prevention-points">
         <li>Schedule regular general checkups to monitor overall health consistently</li>
        <li>Discuss lifestyle, diet, and exercise with your physician regularly</li>
        <li>Monitor blood pressure, sugar, and cholesterol levels frequently</li>
        <li>Address minor symptoms immediately to prevent complications later</li>
        <li>Follow personalized medical guidance provided by your healthcare provider</li>
        <li>Maintain healthy habits such as sleep, diet, and physical activity daily</li>
        <li>Stay aware of family medical history and hereditary risks continuously</li>
        <li>Practice preventive care measures to avoid common illnesses effectively</li>
        <li>Seek professional advice for any unexplained symptoms promptly always</li>
        <li>Maintain vaccination schedules and routine screenings for health protection</li>
        <li>Consult physician for regular mental and emotional well-being assessment</li>
      </ul>
    </div>
